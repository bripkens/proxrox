...
function installOnOSX() {
  ...
  return new Promise(function(resolve) {
    // Okay, now this is fairly dumb. We don't actually need promises here when we are
    // executing the command synchronously. Given the current installation use cases though,
    // synchronous is okay. Will need to revise this once we have more than a single supported
